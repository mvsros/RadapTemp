...
\usepackage[english,ukrainian]{babel}	%переноси
...
\usepackage{multirow,multicol,caption}	% набір тесту у колонки, заголовки 
\usepackage{tabularx} 
\captionsetup[table]{
	labelsep = newline,
	%textfont = sc, 
...
\Title{Шаблон оформлення статті для журналу <<Вісник НТУУ ``КПІ''. Серія Радіотехніка. Радіоапаратобудування>>}\label{radap1xxx:FirstPage}
